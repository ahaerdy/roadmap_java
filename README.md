...
**Recursos Modernos**
- [x] [Tratamento de Exceções](./orientacao_a_objetos/recursos_modernos/tratamento_de_excecoes/) ✓
- [x] [Expressões Lambda](./orientacao_a_objetos/recursos_modernos/expressoes_lambda/) ✓
